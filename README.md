Facing an issue while executing the tests, please log the [issue](https://github.com/sarakps14/mobile-automation-framework-for-amazon.git). 
For any help/queries on this framework. Please feel free to drop an email @ sarakps14@gmail.com If you find it helpful,  **star** the repository and **share** with your network on LinkedIn,Twitter etc :)
Connect with me on [LinkedIn](https://www.linkedin.com/in/saravanan-k-951a9827/)
Cheers!
